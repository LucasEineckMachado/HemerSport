...
<body>
    ...
    <div class="content-wrapper">
        ...
        <aside>
            ...
            Procuramos tornar a experiência de compra fácil e rápida. Por isso, oferecemos pagamento seguro, entregas rápidas e uma navegação simples que ajuda você a encontrar o que procura. O site é feito com tecnologias modernas para garantir que ele seja bonito, responsivo e fácil de usar, seja no computador ou no celular.
            </p>
        </aside>
    </div>
